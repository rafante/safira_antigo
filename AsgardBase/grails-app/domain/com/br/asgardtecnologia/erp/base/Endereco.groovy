...
public class Endereco extends Persistente {
    ...
    String contato
    String email
    String logradouro //logadouro caso vc não saiba é rua, travessa, ponte, avenida etc. (ex.: rua mármore, ou beco 13 de maio, ou av Afonso Pena)
    ...
    //campos e ordenar eles direitinho com espaço e tal (logradouro depois numero depois complemento etc sacou? sim eh isso ele ja pega tudo de uma vez
    //tudo do endereco né? lembrando que o anderson mostrou lá que tá vindo errado o nome do cara, o endereco do cara etc tem que consertar o que tiver ivndo errado
    ...
    //nao faz muito sentido porque eh um serviço dobrado, mas enfim saindo o resultado certo no final hehe ne hahah manda brasa aí
    String toString() {
