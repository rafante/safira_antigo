...
<body><div class="container-fluid">
    <div class="col-xs-12">
        ...
        <div id="page" class="col-12">
            ...
            <fieldset>
                <g:form class="form-horizontal" action="edit" id="${empresaInstance?.id}" enctype="multipart/form-data">
                    <g:hiddenField name="version" value="${empresaInstance?.version}"/>
                    <fieldset>
                        <g:render template="form" model="[empresaInstance: empresaInstance]"/>
