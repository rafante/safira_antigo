<%@ page import="com.br.asgardtecnologia.erp.security.UsuarioPerfil" %>
<!doctype html>
<html>
<head>
...
<body><div class="container-fluid">
    <div class="col-xs-12">
        ...
        <div id="page" class="col-12">
            ...
            <g:hasErrors bean="${usuarioPerfilInstance}">
                <bootstrap:alert class="alert-error">
                    <ul>
                        <g:eachError bean="${usuarioPerfilInstance}" var="error">
            ...
            <fieldset>
                <g:form class="form-horizontal" action="edit" id="${usuarioPerfilInstance?.id}">
                    <g:hiddenField name="version" value="${usuarioPerfilInstance?.version}"/>
                    <fieldset>
                        <g:render template="form" model="[usuarioPerfilInstance: usuarioPerfilInstance]"/>
