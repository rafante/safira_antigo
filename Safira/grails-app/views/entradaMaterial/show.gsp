...
<body><div class="container-fluid">
    <div class="col-xs-12">
        ...
        <div id="page" class="col-12">
            ...
            <fieldset>
                <g:form class="form-horizontal" action="show" id="${entradaMaterialInstance?.id}">
                    <g:hiddenField name="version" value="${entradaMaterialInstance?.version}"/>
                    <fieldset>
                        <g:render template="form" model="[entradaMaterialInstance: entradaMaterialInstance]"/>
                    </fieldset>
                </g:form>
            </fieldset>
