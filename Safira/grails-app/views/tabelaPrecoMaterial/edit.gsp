...
<body><div class="container-fluid">
    <div class="col-xs-12">
        ...
        <div id="page" class="col-12">
            ...
            <g:hasErrors bean="${tabelaPrecoMaterialInstance}">
                <bootstrap:alert class="alert-error">
                    <ul>
                        <g:eachError bean="${tabelaPrecoMaterialInstance}" var="error">
            ...
            <fieldset>
                <g:form class="form-horizontal" action="edit" id="${tabelaPrecoMaterialInstance?.id}">
                    <g:hiddenField name="version" value="${tabelaPrecoMaterialInstance?.version}"/>
                    <fieldset>
                        <g:render template="form" model="[tabelaPrecoMaterialInstance: tabelaPrecoMaterialInstance]"/>
