...
<body><div class="container-fluid">
    <div class="col-xs-12">
        ...
        <div id="page" class="col-12">
            ...
            <g:hasErrors bean="${unidadeMedidaInstance}">
                <bootstrap:alert class="alert-error">
                    <ul>
                        <g:eachError bean="${unidadeMedidaInstance}" var="error">
            ...
            <fieldset>
                <g:form class="form-horizontal" action="edit" id="${unidadeMedidaInstance?.id}">
                    <g:hiddenField name="version" value="${unidadeMedidaInstance?.version}"/>
                    <fieldset>
                        <g:render template="form" model="[unidadeMedidaInstance: unidadeMedidaInstance]"/>
