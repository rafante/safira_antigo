...
<body><div class="container-fluid">
	<div class="col-xs-12">
		...
		<div id="page" class="col-12">
			...
			<g:hasErrors bean="${itemExameInstance}">
				<bootstrap:alert class="alert-error">
					<ul>
						<g:eachError bean="${itemExameInstance}" var="error">
			...
			<fieldset>
				<g:form class="form-horizontal" action="edit" id="${itemExameInstance?.id}">
					<g:hiddenField name="version" value="${itemExameInstance?.version}"/>
					<fieldset>
						<g:render template="form" model="[itemExameInstance: itemExameInstance]"/>
