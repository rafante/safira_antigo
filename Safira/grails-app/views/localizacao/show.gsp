...
<body><div class="container-fluid">
    <div class="col-xs-12">
        ...
        <div id="page" class="col-12">
            ...
            <fieldset>
                <g:form class="form-horizontal" action="show" id="${localizacaoInstance?.id}">
                    <g:hiddenField name="version" value="${localizacaoInstance?.version}"/>
                    <fieldset>
                        <g:render template="form" model="[localizacaoInstance: localizacaoInstance]"/>
                    </fieldset>
                </g:form>
            </fieldset>
