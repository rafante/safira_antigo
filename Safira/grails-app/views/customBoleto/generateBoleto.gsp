...
<body><div class="container-fluid">
    <div class="col-xs-12">
        ...
        <div id="page" class="col-12">
            ...
            <g:hasErrors bean="${boletoInstance}">
                <bootstrap:alert class="alert-error">
                    <ul>
                        <g:eachError bean="${boletoInstance}" var="error">
            ...
            <fieldset>
                <g:form class="form-horizontal" method="POST" action="generateBoleto" id="${boletoInstance?.id}">
                    <g:hiddenField name="version" value="${boletoInstance?.version}"/>
                    <fieldset>
                        <g:render template="form" model="[boletoInstance: boletoInstance]"/>
                        <div class="form-actions form-buttons">
                            ...
                            <button type="submit" class="btn btn-danger" nam    e="_action_delete" formnovalidate>
