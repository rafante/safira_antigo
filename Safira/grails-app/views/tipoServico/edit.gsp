...
<body><div class="container-fluid">
    <div class="col-xs-12">
        ...
        <div id="page" class="col-12">
            ...
            <g:hasErrors bean="${tipoServicoInstance}">
                <bootstrap:alert class="alert-error">
                    <ul>
                        <g:eachError bean="${tipoServicoInstance}" var="error">
            ...
            <fieldset>
                <g:form class="form-horizontal" action="edit" id="${tipoServicoInstance?.id}">
                    <g:hiddenField name="version" value="${tipoServicoInstance?.version}"/>
                    <fieldset>
                        <g:render template="form" model="[tipoServicoInstance: tipoServicoInstance]"/>
