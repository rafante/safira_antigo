...
<body><div class="container-fluid">
    <div class="col-xs-12">
        ...
        <div id="page" class="col-12">
            ...
            <fieldset>
                <g:form class="form-horizontal" action="edit" id="${movimentoMaterialInstance?.id}">
                    <g:hiddenField name="version" value="${movimentoMaterialInstance?.version}"/>
                    <fieldset>
                        <g:render template="form" model="[movimentoMaterialInstance: movimentoMaterialInstance]"/>
