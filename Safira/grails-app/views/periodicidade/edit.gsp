...
<body><div class="container-fluid">
    <div class="col-xs-12">
        ...
        <div id="page" class="col-12">
            ...
            <g:hasErrors bean="${periodicidadeInstance}">
                <bootstrap:alert class="alert-error">
                    <ul>
                        <g:eachError bean="${periodicidadeInstance}" var="error">
            ...
            <fieldset>
                <g:form class="form-horizontal" action="edit" id="${periodicidadeInstance?.id}">
                    <g:hiddenField name="version" value="${periodicidadeInstance?.version}"/>
                    <fieldset>
                        <g:render template="form" model="[periodicidadeInstance: periodicidadeInstance]"/>
