...
<body><div class="container-fluid">
    <div class="col-xs-12">
        ...
        <div id="page" class="col-12">
            ...
            <g:hasErrors bean="${subGrupoInstance}">
                <bootstrap:alert class="alert-error">
                    <ul>
                        <g:eachError bean="${subGrupoInstance}" var="error">
            ...
            <fieldset>
                <g:form class="form-horizontal" action="edit" id="${subGrupoInstance?.id}">
                    <g:hiddenField name="version" value="${subGrupoInstance?.version}"/>
                    <fieldset>
                        <g:render template="form" model="[subGrupoInstance: subGrupoInstance]"/>
