...
<body><div class="container-fluid">
	<div class="col-xs-12">
		...
		<div id="page" class="col-12">
			...
			<g:hasErrors bean="${tipoContaInstance}">
				<bootstrap:alert class="alert-error">
					<ul>
						<g:eachError bean="${tipoContaInstance}" var="error">
			...
			<fieldset>
				<g:form class="form-horizontal" action="edit" id="${tipoContaInstance?.id}">
					<g:hiddenField name="version" value="${tipoContaInstance?.version}"/>
					<fieldset>
						<g:render template="form" model="[tipoContaInstance: tipoContaInstance]"/>
