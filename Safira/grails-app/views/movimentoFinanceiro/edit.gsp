...
<body><div class="container-fluid">
    <div class="col-xs-12">
        ...
        <div id="page" class="col-12">
            ...
            <g:hasErrors bean="${movimentoFinanceiroInstance}">
                <bootstrap:alert class="alert-error">
                    <ul>
                        <g:eachError bean="${movimentoFinanceiroInstance}" var="error">
            ...
            <fieldset>
                <g:form class="form-horizontal" action="edit" id="${movimentoFinanceiroInstance?.id}">
                    <g:hiddenField name="version" value="${movimentoFinanceiroInstance?.version}"/>
                    <fieldset>
                        <g:render template="form" model="[movimentoFinanceiroInstance: movimentoFinanceiroInstance]"/>
